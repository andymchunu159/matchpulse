        ...
        <div className="grid gap-14 md:grid-cols-[1.5fr_1fr_1fr_1fr]">
          ...
          <div className="space-y-6">
            ...
            <p className="max-w-sm text-sm font-medium leading-7 text-zinc-400">
              Live scores, statistics, standings, predictions, and AI-powered
              football insights for fans around the world.
            </p>
          </div>
          ...
          <div className="space-y-6">
            <h3 className="text-[11px] font-medium uppercase tracking-[0.28em] text-zinc-500">
              Football
            </h3>
            ...
            <nav className="flex flex-col gap-2">
              <Link
                href="/live"
                className="group relative rounded-lg px-2 py-2 text-sm font-medium text-zinc-300 transition-all duration-300 hover:bg-white/5 hover:text-white"
              >
                Live Scores
